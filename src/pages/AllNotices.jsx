  ...
  return (
    <div style={{flex:1,overflowY:'auto',padding:'28px 32px',animation:'fadeUp .28s ease'}}>
      <div style={{marginBottom:24}}>
        ...
        <p style={{fontSize:13,color:'var(--text2)'}}>Notices from all your Rooms.</p>
      </div>
      {allNotices.length===0 ? (
        ...
        <div key={i} onClick={()=>selectRoom(n.room)} style={{background:'var(--bg2)',border:'1px solid var(--border)',borderRadius:13,padding:16,marginBottom:12,cursor:'pointer',transition:'border-color .15s'}}
